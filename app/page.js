    ...
    return (
      <div style={{ minHeight:"100vh", display:"flex", flexDirection:"column" }}>
        ...
        <div style={{ flex:1, display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"center", padding:"4rem 2rem", textAlign:"center" }}>
          ...
          <h1 style={{
            fontFamily:"Lora,serif", fontSize:"clamp(2.4rem,5vw,4rem)",
          ...
          <button
            ...
            style={{
              ...
              fontFamily:"Sora,sans-serif", transition:"opacity .15s"
            }}
    ...
    <div style={{ minHeight:"100vh", display:"flex", flexDirection:"column" }}>
      ...
      <nav style={{
        ...
        <div style={{ display:"flex", alignItems:"center", gap:12 }}>
          ...
          <button
            onClick={() => signOut()}
            style={{ background:"none", border:"1px solid var(--border)", color:"var(--muted)", padding:"5px 12px", borderRadius:7, fontSize:".78rem", cursor:"pointer", fontFamily:"Sora,sans-serif" }}
          >
            Sign out
          </button>
        </div>
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    background: active ? "rgba(91,141,238,.1)" : "transparent",
                    border: `1px solid ${active ? "rgba(91,141,238,.35)" : "transparent"}`,
                    transition:"all .12s"
                  }}
                >
                ...
                {readme && (
                  <div style={{ display:"flex", gap:6, alignItems:"center" }}>
                    ...
                    <div style={{ display:"flex", background:"var(--surface2)", border:"1px solid var(--border)", borderRadius:7, overflow:"hidden" }}>
                      {["preview","raw"].map(v => (
                        <button key={v} onClick={() => setView(v)} style={{
                          ...
                          fontFamily:"Sora,sans-serif", background: view===v ? "var(--border2)" : "transparent",
                    ...
                    <button onClick={handleCopy} style={{
                      ...
                      padding:"5px 12px", borderRadius:7, fontSize:".75rem", cursor:"pointer", fontFamily:"Sora,sans-serif", transition:"all .15s"
                    ...
                    <button
                      ...
                      style={{
                        ...
                        background: commitState === "done" ? "rgba(82,208,138,.12)" : "rgba(91,141,238,.1)",
                        border: `1px solid ${commitState === "done" ? "rgba(82,208,138,.4)" : "rgba(91,141,238,.4)"}`,
                        ...
                        fontFamily:"Sora,sans-serif", fontWeight:500, transition:"all .15s"
                      }}
                    >
